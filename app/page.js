      ...
      <section className="grid grid-cols-2 h-[50vh]">
        <div className="0 flex flex-col gap-4 items-center justify-center px-12">
          ...
          <div className='gap-3 items-center'>
            <Link href="/shorten"> <button type="button" className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-3 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Try Now</button></Link>
